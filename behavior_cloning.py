...
argument_parser = argparse.ArgumentParser(description="A script used to clone expert data into agent.")
...
trainer = SupervisedTrainer(agent, env, args.input_path, render=args.render, device=device)
